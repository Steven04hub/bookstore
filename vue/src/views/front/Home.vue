<template>
  <div class="main-content">
    <div style="height: 60px; background-color: green"></div>
        ...
        <div style="display: flex; margin: 0 25px; height: 550px">
          ...
          <div style="flex: 3; background-color: #F3F3F3FF; margin-top: 15px; margin-left: 15px; border-radius: 10px">
            ...
            <div style="display: flex; margin-top: 50px">
              ...
              <div style="flex: 1; text-align: center">
                <a href="/front/cart"><img src="@/assets/imgs/购物车.png" alt="" style="height: 25px; width: 25px"></a>
                <div>我的购物车</div>
              </div>
              <div style="flex: 1; text-align: center">
           ...
           <div style="margin: 40px 0 0 15px; height: 40px; background-color: #04BF04FF; font-size: 20px; color: white; width: 130px; font-weight: bold; line-height: 40px; text-align: center; border-radius: 20px">特色书籍</div>
        <div style="margin: 10px 5px 0 5px">
          <el-row>
          <el-col :span="5" v-for="item in goodsData">
          <img @click="navTo('/front/detail?id=' + item.id)" :src="item.img" alt="" style="width: 80%; height: 175px; border-radius: 10px; border: #cccccc 1px solid">
...
export default {
  ...
  data() {
    return {
      ...
      goodsData: [],
      carousel_top: [
        require('@/assets/imgs/book-1.png'),
        require('@/assets/imgs/book-2.png'),
        require('@/assets/imgs/book-3.png'),
      ],
      carousel_left: [
        require('@/assets/imgs/book-4.png'),
        require('@/assets/imgs/book-5.png'),
        require('@/assets/imgs/book-6.png'),
      ],
      carousel_right: [
        require('@/assets/imgs/book-7.png'),
        require('@/assets/imgs/book-8.png'),
        require('@/assets/imgs/book-9.png'),
      ],
    }
  },
  mounted() {
